# -*- coding: utf-8 -*-
from bin_search_engine import bin_search_find
from bin_search_obj import ListObject
...
print(bin_search_find(var_list, 12).Data)

#Obtendo a pessoa chamada Foxaevoy
print(bin_search_find(var_list, 15).Data)

#Obtendo a pessoa chamada Grulhnikh
print(bin_search_find(var_list, 9).Data)
